...
def main():
    # TODO: 2019-05-10: Used to develop and test extracting model output parameters
    ...
    if len(hru_order_subset) > 0:
        for vv in output_vars:
            ...
            mod_out = ModelOutput(filename=filename, varname=vv, startdate=st_date, enddate=en_date, nhm_hrus=hru_order_subset)
